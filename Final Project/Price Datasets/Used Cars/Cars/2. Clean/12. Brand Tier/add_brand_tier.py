...
input_file = os.path.join(script_dir, 'cleaned_cars_v8.csv')
output_file = os.path.join(script_dir, 'cleaned_cars_v9.csv')
...
# Reorder columns to put Brand_Tier before Image Paths
